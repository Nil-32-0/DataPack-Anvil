...
import metafact.dpanvil_m.api.predicate.block.logical.AndBlockPredicate;
import metafact.dpanvil_m.api.predicate.block.logical.AnyBlockPredicate;
import metafact.dpanvil_m.api.predicate.block.logical.NoneBlockPredicate;
import metafact.dpanvil_m.api.predicate.block.logical.NotBlockPredicate;
import metafact.dpanvil_m.api.predicate.block.logical.OrBlockPredicate;
import metafact.dpanvil_m.api.predicate.block.match.MatchBlockPredicate;
import metafact.dpanvil_m.api.predicate.block.match.MatchBlockStatePredicate;
import metafact.dpanvil_m.api.predicate.block.match.MatchBlockTagPredicate;
import metafact.dpanvil_m.api.predicate.block.match.MatchBlocksPredicate;
import metafact.dpanvil_m.api.predicate.block.world.CacheBlockPredicate;
import metafact.dpanvil_m.api.predicate.block.world.OffsetBlockPredicate;
