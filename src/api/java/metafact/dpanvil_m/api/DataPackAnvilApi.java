...
public class DataPackAnvilApi {
	...
	public static final String MODID = "dpanvil_m";
	...
	public static synchronized IDataPackAnvilService service() {
		if (service == null) {
				...
				service = loader.findFirst().orElseGet(() -> {
					...
					try {
						Constructor<?> constructor = Class.forName("sirttas.dpanvil_m.DataPackAnvilService", true, DataPackAnvilApi.class.getClassLoader()).getDeclaredConstructor();
